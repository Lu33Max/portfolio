  ...
  return (
    <div>
      <nav className="bg-[rgba(0,0,0,0.1)] py-[0.5rem] px-0 z-30 backdrop-blur-2xl fixed top-0 w-full">
        <div className={"max-w-[1300px] flex items-center justify-between py-[1rem] px-0 my-0 mx-[2rem] xl:mx-auto"}>
          <p className='text-lg font-semibold'><Link href={"/"}>Lucas Maximilian Ernst</Link></p>
