...
const ExperienceCard = ({details, type}: Props) => {
  return (
    <div className='work-experience-card max-md:m-0 bg-[#130f2a] rounded-xl border-solid border-2 border-[#6751b9] py-6 px-10 mx-4'>
      ...
      <div className={`flex ${type==="game" ? "flex-col" : "flex-row justify-between items-center gap-4 max-md:flex-col max-md:gap-0"}`}>
        <div>
        ...
        <div className={`${type==="other" && "lg:max-w-[48%]"}`}>
