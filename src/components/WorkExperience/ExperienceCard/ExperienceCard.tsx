  ...
  return (
    <div className='work-experience-card max-md:m-0 bg-[#130f2a] rounded-xl border-solid border-2 border-[#6751b9] py-6 px-10 mx-4'>
      <div className='flex justify-between items-center'>
        <div>
          <h6 className='text-[1.05rem] font-semibold mb-3'>{details.title}</h6>
          <div className='work-duration inline-block text-xs font-normal bg-[#6751b980] rounded-md py-2 px-3 mb-5'>
            {details.date}
          </div>
        </div>
        {details.link}
      </div>
      <ul className='list-none text-[0.9rem] font-normal mb-4'>
