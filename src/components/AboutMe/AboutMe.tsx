  ...
  return (
    <section className='my-16'>
      ...
      <p className='mx-8 leading-6 text-justify min-[2000px]:text-2xl'>
        ...
        theoretical knowledge about the process behind creating a game I am now looking for more opportunities to bring this knowledge into practice. Following this goal two university 
        colleagues and I are currently working on a digital board game experience which hope to present to the public later this year.
      </p>
    </section>
  )
}
