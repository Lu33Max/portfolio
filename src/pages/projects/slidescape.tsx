...
export default function Slidescape()  {
  return (
    <>
      ...
      <>
        <h2 className='text-center md:text-left min-[2000px]:text-8xl sm:text-5xl text-4xl lg:text-6xl font-semibold leading-[3rem] sm:leading-[4rem] lg:leading-[5rem] mt-12 md:mt-0 md:mb-[1rem]'>Slidescape</h2>
        ...
        <h5 className='text-2xl font-semibold my-12 max-md:text-xl max-md:my-8 min-[2000px]:text-4xl'>My Process</h5>
        <div className='mx-8 max-sm:mx-0 text-justify'>
          <p className='mb-4 min-[2000px]:text-[1.5rem]'>
        ...
        <div className='mx-8 max-sm:mx-0'>
          <ul className='list-none mb-8 ml-5 min-[2000px]:text-[1.5rem]'>
