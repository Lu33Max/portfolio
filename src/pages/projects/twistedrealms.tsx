...
export default function TwistedRealms()  {
  return (
    <>
      ...
      <>
        <h2 className='text-center md:text-left sm:text-5xl text-4xl lg:text-6xl font-semibold leading-[3rem] sm:leading-[4rem] lg:leading-[5rem] mt-12 md:mt-0 mb-4'>Twisted Realms</h2>
        ...
        <div className='mx-8'>
          ...
          <div className='flex items-center max-md:flex-col gap-4'>
            ...
            <div>
            <p className='mb-4 max-xl:hidden'>
              In the second step, as Technical Lead, it is now my responsibility to implement previously defined game mechanics in the engine. Since this project is an opportunity for all 
              of us on the team to learn and expand our skills, we chose the Unreal Engine for implementation, with which I personally had limited experience until then.
            </p>
            <p>
        ...
        <div className='mx-8'>
          <ul className='list-disc list-inside mb-8'>
            <li className='mb-1'>Identifying and addressing issues in existing game concepts</li>
            <li className='mb-1'>Independent work and organization within a team</li>
            <li className='mb-1'>Structured documentation and dissemination of work results</li>
            <li className='mb-1'>Engaging in reasoned discussions of solution approaches within a team</li>
            <li className='mb-1'>Game development in the Unreal Engine</li>
            <li className='mb-1'>Development of procedural generation algorithms and balancing them</li>
          </ul>
        </div>
        <hr/>
        <p className='mt-2 mb-4'>
          <b>Download the Game Design Document <a title="Game Design Document" download href="\assets\documents\Twisted_Realms_GDD.pdf" className='text-[#9678ff] hover:text-[#b7a3ff] transition-colors duration-300'><u>here</u></a>.</b>
        </p>
      </>
    </>
  )
